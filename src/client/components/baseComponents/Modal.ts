...
export class OModal extends LitElement {
  ...
  render() {
    ...
    const sectionClass =
      "crownfront-modal-surface relative flex-1 min-h-0 flex flex-col overflow-hidden";
      ...
      >
        ...
        >
          ...
          ${!this.hideHeader && this.title
            ? html`<div
                class="px-[1.4rem] py-[1rem] text-2xl font-display font-bold text-bright-white"
              >
                ${this.title}
              </div>`
            : html``}
