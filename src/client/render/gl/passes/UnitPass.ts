 ...
 *
 * Renders galleys, cogs, caravans and siege projectiles from an original SVG
 * atlas. Fixed map-symbol silhouettes keep their existing world footprints.
 * Grayscale heraldry bands retain player colors and every combat-state signal.
 *
 ...
 *
 * Atlas layout (12 columns, generated by scripts/generate-crownfront-art.mjs):
 *   Col 0: Troop galley / Transport (5×5)
 *   Col 1: Merchant cog / Trade Ship (5×5)
 *   Col 2: War galley / Warship (11×11)
 *   Col 3: Wildfire pot / Atom Bomb (7×7)
 *   Col 4: Dragonfire / Hydrogen Bomb (9×9)
 *   Col 5: Plague volley / MIRV (13×13)
 *   Col 6: Ballista bolt / SAM Missile (3×3)
 *   Col 7: Siege stone / Shell (1×1)
 *   Col 8: Plague vessel / MIRV Warhead (3×3)
 *   Col 9: Caravan lead cart / Train Engine (5×5)
 *   Col 10: Empty cart / Train Carriage (5×5)
 *   Col 11: Laden cart / Train Carriage Loaded (5×5)
 *
 * Data flow:
...
const unitAtlasUrl = assetUrl("atlases/unit-atlas.svg");
