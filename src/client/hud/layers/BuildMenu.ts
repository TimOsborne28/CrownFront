...
export class BuildMenu extends LitElement implements Controller {
  ...
  static styles = css`
    ...
    .build-menu {
      ...
      z-index: 9999;
      background: var(--realm-wood), var(--realm-ink, #151c17);
      border: 1px solid var(--realm-brass-muted, #7a6545);
      padding: 15px;
    ...
    .build-button {
      ...
      width: 120px;
      min-height: 158px;
      border: 1px solid var(--realm-border, #92794d70);
      background-color: var(--realm-panel, #232a21);
      color: var(--realm-parchment, #efe5cc);
      border-radius: 4px;
      cursor: pointer;
    ...
    .build-button:not(:disabled):hover {
      background-color: var(--realm-panel-raised, #34392a);
      transform: translateY(-2px);
      border-color: var(--realm-brass, #c6a36a);
    }
    .build-button:not(:disabled):active {
      background-color: #404633;
              ...
              ${row.map((item) => {
                ...
                return html`
                  ...
                  >
                    <img
                      src=${item.icon}
                      alt=${unitDisplayName(item.unitType)}
                      width="40"
                      height="40"
                    />
