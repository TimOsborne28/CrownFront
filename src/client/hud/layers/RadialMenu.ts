...
export class RadialMenu implements Controller {
  ...
  private readonly defaultCenterButtonColor = "#202d23";
  ...
  private createTooltipElement() {
    ...
    this.tooltipElement.style.background = "rgba(25, 35, 28, 0.96)";
    this.tooltipElement.style.border = "1px solid #92794d";
    this.tooltipElement.style.color = "#efe5cc";
    ...
    arcs
      ...
      .attr("fill", (d) => {
        ...
        const color = disabled
          ...
          : (resolveColor(d.data, this.params) ?? "#344534");
