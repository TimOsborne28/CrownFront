...
const DEFAULT_DIVIDER_CLASS = "border-b border-malibu-blue/25";
const DEFAULT_PADDING_CLASS = "p-4 lg:p-6";
const DEFAULT_LEFT_CLASS = "flex items-center gap-4 flex-1";
const DEFAULT_BUTTON_CLASS =
  "group flex items-center justify-center w-10 h-10 rounded shrink-0 " +
  "bg-gray-800 hover:bg-gray-700 transition-colors border border-malibu-blue/25";
export const DEFAULT_TITLE_CLASS =
  "text-bright-white text-xl lg:text-2xl font-display font-bold " +
