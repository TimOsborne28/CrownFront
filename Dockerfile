...
COPY map-generator ./map-generator
COPY LICENSE LICENSE-ASSETS LICENSING.md README.md CREDITS.md CONTRIBUTING.md CLAUDE.md ./
COPY Dockerfile nginx.conf supervisord.conf generate-nginx-upstream.sh example.env ./
COPY .dockerignore .gitignore .oxlintrc.json .prettierrc .swcrc ./
