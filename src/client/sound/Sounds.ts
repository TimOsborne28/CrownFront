...
export const soundEffectUrls: ReadonlyMap<SoundEffect, string> = new Map([
  ...
  ["atom-hit", assetUrl("sounds/crownfront/fire.wav")],
  ["atom-launch", assetUrl("sounds/crownfront/siege.wav")],
  ["hydrogen-hit", assetUrl("sounds/crownfront/fire.wav")],
  ["hydrogen-launch", assetUrl("sounds/crownfront/siege.wav")],
  ["mirv-launch", assetUrl("sounds/crownfront/siege.wav")],
  ["alliance-suggested", assetUrl("sounds/crownfront/bell.wav")],
  ...
  ["message", assetUrl("sounds/crownfront/bell.wav")],
  ...
  ["nuke-warning", assetUrl("sounds/crownfront/horn.wav")],
...
export const ambienceUrls: ReadonlyMap<AmbienceTrack, string> = new Map([
  ...
  ["factory", assetUrl("sounds/crownfront/forge.wav")],
  ["missile-silo", assetUrl("sounds/crownfront/forge.wav")],
  ["sam-silo", assetUrl("sounds/crownfront/forge.wav")],
]);
