...
## CrownFront modified edition

**© OpenFront and Contributors**

CrownFront is an unofficial medieval modification, not endorsed by OpenFront Inc.
September 2026 modifications include the CrownFront crown/shield identity,
parchment cartography, medieval unit and interface artwork, English display names,
local-only service configuration, and original synthesized lute, horn, bell,
siege, fire and forge audio. Original CrownFront artwork and audio are licensed
CC BY-SA 4.0, attributed to **CrownFront contributors**; code is AGPL-3.0.
No proprietary OpenFront artwork, premium assets or music is used.
Retained open-resource assets are attributed to **OpenFront and Contributors**
under CC BY-SA 4.0, subject to the specific third-party notices below.

The running edition provides its own modified source at `/source`.
