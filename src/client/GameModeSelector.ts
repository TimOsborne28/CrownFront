...
const PRIMARY_ACTION = "crownfront-action crownfront-action-primary";
const SECONDARY_ACTION = "crownfront-action crownfront-action-secondary";
const DISABLED = "opacity-50 cursor-not-allowed pointer-events-none";
/** Tutorial card: the panel's gold, dark text for contrast. */
const TUTORIAL_ACTION = "crownfront-action crownfront-action-secondary";
...
export class GameModeSelector extends LitElement {
  ...
  render() {
    ...
    return html`
      <div class="crownfront-mode-grid">
        <ios-add-to-home-screen-banner
          class="no-crazygames [&:empty]:hidden sm:col-span-2 sm:row-start-1"
        ></ios-add-to-home-screen-banner>

        <div class="crownfront-primary-actions">
          <div class="flex-[2]">
            ${this.renderSmallActionCard(
              translateText("crownfront.solo"),
        ...
        <div class="crownfront-secondary-actions">
          ${this.renderSmallActionCard(
            translateText("crownfront.host"),
            this.openHostLobby,
            SECONDARY_ACTION,
            undefined,
            true,
        ...
        <section class="crownfront-live-lobbies">
          ${ffa
            ? html`<div class="crownfront-lobby-card">
  ...
  private renderSmallActionCard(
    ...
    return html`
      <button
        ...
        class="relative flex items-center justify-center w-full h-full ${bgClass} transition-all duration-200 text-sm lg:text-base font-medium uppercase tracking-wider text-center ${!this
          .inputValid
          ? DISABLED
          : blocked
