...
export class UsernameInput extends LitElement {
  ...
  private renderClanControl() {
    if (isCrownFrontLocal()) {
      return html`
        <input
          class="w-24 h-full shrink-0 border-r border-malibu-blue/25 bg-transparent px-2 text-center text-sm uppercase text-aquarius placeholder-gray-400"
          .value=${this.clanTag}
